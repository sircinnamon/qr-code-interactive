// Borrowed from https://raw.githubusercontent.com/bitwiseshiftleft/sjcl/master/core/bitArray.js -RL
...
bitArray = {
  ...
  /** Print a string representation of the bitArray
   * (does not handle partial words)
   * @param {bitArray} a word array
   * @return {string} 0 and 1 representation
   */
  toString: function(a) {
    let out = ""
    for (let i = bitArray.bitLength(a) - 1; i >= 0; i--) {
      out = bitArray.extract(a, i, 1) + out
    }
    return out
  }
};
